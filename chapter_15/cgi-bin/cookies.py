...
'''
lists a CGI script that stores a clientside
cookie when first visited and receives and displays it on subsequent visits.
'''
...
print(greeting)                                     # and teh actual html
