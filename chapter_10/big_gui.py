...
from chapter_10.guimixin import *                           # mix-in methods: quit, spawn, etc.
from chapter_10.guimaker import *                           # frame, plus menu/toolbar builder
...
class Hello(GuiMixin, GuiMakerWindowMenu):                  # or GuiMakerFrameMenu
    ...
    def fileOpen(self):
        pick = self.selectOpenFile(file='big-gui.py')
        if pick:
