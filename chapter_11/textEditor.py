...
from chapter_10.guimaker  import *                # Frame + menu/toolbar builders
...
class TextEditor:                        # mix with menu/toolbar Frame class
    ...
    def onGrep(self):
        ...
        """
        from chapter_10.formrows import makeFormRow
    ...
    def grepThreadProducer(self, filenamepatt, dirname, grepkey, encoding, myqueue):
        ...
        """
        from chapter_6.find import find
        matches = []
        try:
    ...
    def grepMatchesList(self, matches, grepkey, encoding):
        ...
        """
        from chapter_9.scrolledlist import ScrolledList
    ...
    def onRunCode(self, parallelmode=True):
        ...
        from chapter_5.launchmodes import System, Start, StartArgs, Fork
        filemode = False
